...
import (
	...
	"github.com/uliseslugo/lugo_compiler/lexer"
...
func (p *Parser) parseBoolean() ast.Expression {
	return &ast.Boolean{Token: p.currToken,
...
// Checks if next token is equal to the one we want and
// if it is, advances currToken pointer (To token we expected)
